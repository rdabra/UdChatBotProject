...
ChatBot::ChatBot(std::string filename) {
  std::cout << "Constructing ChatBot..." << std::endl;
...
ChatBot::~ChatBot() {
  std::cout << "Destructing ChatBot..." << std::endl;
...
ChatBot::ChatBot(const ChatBot &other) {
  std::cout << "Copy-Constructing chatbot..." << std::endl;
  this->_image = new wxBitmap{other._image->ConvertToImage()};
...
ChatBot::ChatBot(ChatBot &&other) noexcept {
  std::cout << "Move-Constructing chatbot..." << std::endl;
...
ChatBot &ChatBot::operator=(const ChatBot &other) {
  if (this != &other) {
    std::cout << "Copy-Assigning chatbot..." << std::endl;
    if (this->_image != NULL)
      delete this->_image;
    this->_image = new wxBitmap{other._image->ConvertToImage()};
    this->_currentNode = other._currentNode;
...
ChatBot &ChatBot::operator=(ChatBot &&other) noexcept {
  std::cout << "Move-Assigning chatbot..." << std::endl;
  this->_image = other._image;
  this->_currentNode = other._currentNode;
  this->_rootNode = other._rootNode;
  this->_chatLogic = other._chatLogic;
